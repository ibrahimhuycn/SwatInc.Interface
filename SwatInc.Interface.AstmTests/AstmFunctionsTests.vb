...
Imports SwatInc.Interface.Astm.AstmFunctions

<TestClass()> Public Class AstmFunctionsTests
    ...
    <TestMethod()> Public Sub DetermineFrameType_HeaderFrame_r0r1r2r3r4r5()
        ...
        Dim TestAstmFrame0 As String = String.Format("{0}1H|¥^&|||U-WAM^00-08_Build008^11001^^^^AU501736||||||||LIS2-A2|20170307144247{1}{2}B8{3}{4}", STX, CR, ETX, CR, LF)
        Dim TestAstmFrame1 As String = String.Format("{0}O|1|123456^05^1234567890123456789012^B^O||^^^^CHM\^^^^UF||20040807101000|||||N||||||| |||||||Q{1}{2}B8{3}{4}", STX, CR, ETX, CR, LF)
        Dim TestAstmFrame2 As String = String.Format("{0}2P|1||P00001||Sample^Ichiro^^¥Sample^Ichiro||19701130|M||||||ANEG||||KIDNEY1||||||IP{1}{2}B8{3}{4}", STX, CR, ETX, CR, LF)
        Dim TestAstmFrame3 As String = String.Format("{0}6R|2|^^^C-PH^A^1^S^0002^01|7.5^MAINFORMAT|||N||||^^admin^administrator||20151110105603|UC_3500{1}{2}B8{3}{4}", STX, CR, ETX, CR, LF)
        Dim TestAstmFrame4 As String = String.Format("{0}2Q|1|20150730001||||20170307144247||||||C{1}{2}B8{3}{4}", STX, CR, ETX, CR, LF)
        Dim TestAstmFrame5 As String = String.Format("{0}6C|1||S^Sample Comment{1}{2}B8{3}{4}", STX, CR, ETX, CR, LF)
        Dim TestAstmFrame6 As String = String.Format("{0}3L|1|N{1}{2}B8{3}{4}", STX, CR, ETX, CR, LF)
    ...
    <TestMethod()> Public Sub GetCheckSumValue_PassAstmFrame_GetValidChecksum()
        ...
        Dim CalculateChecksum As New Astm.AstmFunctions
        'ACT
    ...
    <TestMethod()> Public Sub IsAstmFrameComplete_PassCompleteAstmFrameWithCrEtx_ReturnTrueAsComplete()
        'ARRANGE
        Dim TestAstmFrame As String = String.Format("2[Text]{0}{1}A6{2}{3}", CR, ETX, CR, LF)
        Dim IsFrameComplete As New Astm.AstmFunctions
        'ACT
    ...
    <TestMethod()> Public Sub IsAstmFrameComplete_PassCompleteAstmFrameWithEtb_ReturnTrueAsComplete()
        ...
        Dim TestAstmFrame As String = String.Format("{0}2[Text]{1}A6{2}{3}", STX, ETB, CR, LF)
        Dim ValidateASTM As New Astm.AstmFunctions
        'ACT
    ...
    <TestMethod()> Public Sub IsAstmFrameComplete_PassIncompleteAstmFrameNoEtx_ReturnFalseAsIncomplete()
        'ARRANGE
        Dim TestAstmFrame As String = String.Format("1H|¥^&|||U-WAM^00-08_Build008^11001^^^^AU501736||||||||LIS2-A2|20170307144247{0}{1}", CR, LF)
        Dim IsFrameComplete As New Astm.AstmFunctions
        'ACT
        Dim ActualValue As Boolean = IsFrameComplete.IsAstmRecordComplete(TestAstmFrame)
        'ASSERT
    ...
    <TestMethod()> Public Sub IsAstmFrameValid_ValidChecksum_True()
        'ARRANGE
        Dim TestAstmFrame0 As String = String.Format("{0}1H|¥^&|||U-WAM^00-08_Build008^11001^^^^AU501736||||||||LIS2-A2|20170307144247{1}{2}B8{3}{4}", STX, CR, ETX, CR, LF)
        Dim TestAstmFrame1 As String = String.Format("{0}1foo|1{1}{2}32{3}{4}", STX, CR, ETX, CR, LF)
        Dim IsFrameComplete As New Astm.AstmFunctions
        'ACT
    ...
    <TestMethod()> Public Sub ReplaceControlCharacters_CheckAllCharactersInUse_ConvertedAsciiControlCharacters()
        ...
        Dim ReplaceChars As New Astm.AstmFunctions
        'ACT
